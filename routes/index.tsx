    ...
    <div class={tw`w-full h-screen flex justify-center bg-gray-900 items-center py-4 px-4 md:(py-4 px-40) lg:(py-4 px-40) relative`}>
      ...
      <div class={tw`w-full h-screen md:(h-80) lg:(h-80) flex flex-row shadow-2xl bg-black rounded-xl relative`}>
        ...
        <div class={tw`grid grid-cols-12 md:gap-4 w-full h-full`}>
          ...
          <div class={tw`col-span-full md:col-span-8 w-full h-auto md:h-full flex justify-start md:justify-center items-center pb-8 md:pb-0 px-4 md:px-8 relative`}>
            <div class={tw`w-full h-auto flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-2 justify-start md:justify-between items-start md:items-center`}>
              <div class={tw`w-auto h-auto md:max-w-sm px-4 md:px-0`}>
                <p class={tw`my-0 font-black text-8xl text-white`}>
                  Hej, 
                </p>
              </div>
              <div class={tw`grid grid-cols-4 gap-2 md:gap-4 w-full md:w-auto h-auto justify-center items-center md:items-end px-0 md:px-8`}>
                <div class={tw`col-span-1 w-auto h-auto flex justify-center items-center rounded shadow bg-transparent`}>
